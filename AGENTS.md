...
This is the central documentation for the "I Can Teach You AI" platform. Codex (or Cursor) must read and adhere to these rules when working on this project.
...
## 3. Codex Behavior Rules

These rules govern how Codex must behave on every task, every session. They are not suggestions.

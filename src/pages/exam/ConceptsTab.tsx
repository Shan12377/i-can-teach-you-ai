  ...
  return (
    <div>
      ...
      <p className={`${styles.menuSub} ${styles.tabIntro}`}>
        Click any domain to expand. Includes the newer confirmed exam topics: CWM framework, prompt caching, 4D
        Framework, transport selection, model selection, hooks event model, and HITL patterns.
      </p>
